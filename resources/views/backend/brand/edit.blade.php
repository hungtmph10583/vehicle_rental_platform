...
@section('subheader__title', 'Sửa Hãng Xe')
@section('subheader__breadcrumbs')
    ...
    <li class="m-nav__item">
        <span class="m-nav__link-text">Sửa Hãng Xe</span>
    </li>
    <li class="m-nav__separator">-</li>
    <li class="m-nav__item">
                ...
                <form method="POST" action="" class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data">
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror m-input m-input--square mb-1" id="name" name="name" placeholder="Nhập Tên Hãng Xe" value="{{ $brand->name }}">
                            @error('name')
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-8">
                                ...
                                <input type="text" class="form-control m-input m-input--square mb-1" id="slug" name="slug" value="{{ $brand->slug }}">
                                @error('slug')
                                    <span class="form__help text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group m-form__group">
                            <label for="logo"><span class="m--font-boldest">Logo</span></label>
                            <div class="row mb-2">
                                <div class="col-4">
                                    <img style="width: 125px; height: 125px; object-fit: cover;" id="preImage" src="@if(empty($brand->logo)) {{ asset('theme/backend/assets/app/media/img/bg/blank-image.svg') }}  @else {{ asset( $brand->logo )}} @endif" alt="">
                                </div>
                            </div>
                        ...
                        <div class="form-group m-form__group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="uploadImage" name="logo">
