...
@section('subheader__title', 'Cập Nhật Thông Tin')
@section('subheader__breadcrumbs')
    ...
    <li class="m-nav__item">
        <span class="m-nav__link-text">Cập Nhật Thông Tin</span>
    </li>
    <li class="m-nav__separator">-</li>
    <li class="m-nav__item">
    ...
    <div class="row">
                    ...
                    <div class="m-card-profile">
                        ...
                        <div class="m-card-profile__pic">
                            <div class="m-card-profile__pic-wrapper">
                                ...
                                @else
                                    <img src="{{ asset('theme/backend/assets/app/media/img/bg/blank-image.svg')}}" class="m--img-rounded m--marginless" style="width: 130px; height: 130px; overflow: hidden; object-fit: contain;" alt="" />
                                @endif
                            </div>
                        </div>
                        <div class="m-card-profile__details">
                            ...
                            @foreach($user->roles as $role)
                                <span class="m-badge m-badge--{{ $role->color }} m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-{{ $role->color }}">{{ $role->name }}</span>
                            @endforeach
                        ...
                        <div class="m-widget1__item">
                            <div class="row m-row--no-padding align-items-center">
                                <div class="col">
                                    ...
                                    <span class="m-widget1__desc">ID-{{ $user->id }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="m-widget1__item">
                        ...
                        <div class="m-widget1__item">
                            <div class="row m-row--no-padding align-items-center">
                                <div class="col">
                                    ...
                                    <span class="m-widget1__desc">{{ Carbon\Carbon::parse($user->recent_personal_login->last_login_at)->diffForHumans() }}</span>
                                </div>
                            </div>
                        </div>
                        @endif
                        @if(!empty($user->recent_personal_login->last_login_ip))
                        <div class="m-widget1__item">
                            <div class="row m-row--no-padding align-items-center">
                                <div class="col">
                                    <h3 class="m-widget1__title">Last Login Ip</h3>
                                    <span class="m-widget1__desc">{{ $user->recent_personal_login->last_login_ip }}</span>
                                </div>
                            </div>
                        </div>
                        @endif
        ...
        <div class="col-xl-7 mr-auto col-lg-8">
            <div class="m-portlet m-portlet--full-height">
                ...
                <!--begin::Form-->
                <form method="POST" class="m-form m-form--label-align-right" enctype="multipart/form-data">
                @csrf
                    <div class="m-portlet__body">
                        <div class="m-form__section m-form__section--first">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control m-input" name="username" value="{{ $user->username }}" placeholder="Enter your username">
                                    @error('username')
                                        <span class="form__help text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-8 m-radio-inline">
                                    ...
                                    <label class="m-radio m-radio--solid">
                                        <input type="radio" name="status" value="3" @if($user->status == 3) checked @endif> Suspended
                                        <span></span>
                                    </label>
                                </div>
                            </div>
                            @if(Auth::user()->hasPermissionTo('browse role') && Auth::user()->id != $user->id)
