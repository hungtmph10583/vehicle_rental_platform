...
@section('subheader__title', 'Thông tin tài khoản')
@section('content')
<div class="m-content">
    <!--Begin::Section-->
    <div class="row">
                    ...
                    <div class="m-card-profile">
                        ...
                        <div class="m-card-profile__pic">
                            <div class="m-card-profile__pic-wrapper">
                                ...
                                @else
                                    <img src="{{ asset('theme/backend/assets/app/media/img/bg/blank-image.svg') }}" class="rounded m--marginless" style="width: 130px; height: 130px; overflow: hidden; object-fit: contain;" alt="" />
                                @endif
                            </div>
                        </div>
                                                ...
                                                <div class="m-dropdown__content">
                                                    <ul class="m-nav">
                                                        ...
                                                        <li class="m-nav__item">
                                                            <a href="{{ route('backend.user.edit', [$user->id]) }}" class="m-nav__link">
                                                                <i class="m-nav__link-icon la la-pencil-square"></i>
                                                                <span class="m-nav__link-text">Update Account</span>
                                                            </a>
                                                        </li>
                                                        <li class="m-nav__item">
                                                            <a href="javascript:;" data-url="{{ route('backend.user.destroy', [$user->id]) }}" class="m-nav__link destroy-user">
                                                                <i class="m-nav__link-icon la la-user-times"></i>
                                                                <span class="m-nav__link-text m--font-danger">Delete Account</span>
                                                            </a>
                                                        </li>
                            ...
                            <div class="m-portlet__body">
                                ...
                                <div class="form-group m-form__group row">
                                    <div class="col-6 mr-auto">
                                        <h4 class="m-form__section">Thông tin tài khoản</h4>
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
                                ...
                                <div class="form-group m-form__group row">
                                    ...
                                    <div class="col-9">
                                        <input class="form-control m-input" type="text" disabled value="{{ $user->username }}">
                                    </div>
                                </div>
                                <div class="form-group m-form__group row">
