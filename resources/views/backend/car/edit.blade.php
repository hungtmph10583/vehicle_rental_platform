                ...
                <form method="POST" action="" class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data">
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror m-input m-input--square mb-1" id="name" name="name" placeholder="Nhập tên sản phẩm" value="{{ $product->name }}">
                            @error('name')
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4">
                                ...
                                <input type="text" class="form-control @error('code') is-invalid @enderror m-input m-input--square mb-1" id="code" name="code" placeholder="Nhập mã sản phẩm" value="{{ $product->code }}">
                                @error('code')
                                    <span class="form__help text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="col-lg-8">
                                ...
                                <input type="text" class="form-control m-input m-input--square mb-1" id="slug" name="slug" value="{{ $product->slug }}">
                                @error('slug')
                                    <span class="form__help text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <select class="form-control m-bootstrap-select m_selectpicker" id="e_commerce_platform_id" name="e_commerce_platform_id" data-live-search="true">
                                @foreach($eCommercePlatforms as $eCommercePlatform)
                                    <option value="{{ $eCommercePlatform->id }}" @if($product->e_commerce_platform_id == $eCommercePlatform->id) selected @endif>{{ $eCommercePlatform->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <div class="m-input-icon m-input-icon--right">
                                <input type="text" class="form-control @error('link_aff') is-invalid @enderror m-input m-input--square mb-1" id="link_aff" name="link_aff" placeholder="Enter Link Affiliate" value="{{ $product->link_aff }}">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <div class="row mb-2">
                                <div class="col-4">
                                    <img style="width: 125px; height: 125px; object-fit: cover;" id="preImage" src="@if(empty($product->thumb_url)) {{ asset('theme/backend/assets/app/media/img/bg/blank-image.svg') }}  @else {{ asset( $product->thumb_url )}} @endif" alt="">
                                </div>
                            </div>
                        ...
                        <div class="form-group m-form__group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="uploadImage" name="thumb_url">
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-7">
                                ...
                                <div class="m-input-icon m-input-icon--right">
                                    <input type="text" class="form-control @error('price') is-invalid @enderror m-input m-input--square mb-1" id="price" name="price" placeholder="150000" value="{{ $product->price }}">
                            ...
                            <div class="col-lg-5">
                                ...
                                <div class="m-radio-inline">
                                    ...
                                    <label class="m-radio m-radio--solid">
                                        <input type="radio" name="status" value="2" @if($product->status == 2) checked @endif> Inactive
                                        <span></span>
                                    </label>
                                </div>
                            </div>
